---
layout: page
title: Calibration fixture 8.4 drawings
tip: drawings of calib_8.4
date:   2026-06-09 01:00:00 -0700
binder:
  ...
  themes: [ calibFix.8 ] # applies to chapter level
---
Last update {{ page.date | date: "%d %b %Y" }}.

{% capture image-dir %}
  {{site.url}}/assets/mini/project/su.piston.position/calibFixture/series-8/
{% endcapture %}

# SU Piston Position Calibration Fixture for 8.4 design
...
for the calib_8.4 fixture.

---
<br>
### 3p_sensor_8.4 flex sheet
...
{% include figure.html
           img-dir=image-dir
           img-file='a.flexPanel_8.4-comp.png'
           alt='Drawing of 3p_sensor_8.4 flex sheet'
           caption='3p_sensor_8.4 flex sheet'
%}
...
This is the same target board as used for calibration fixture 7.2

{% include figure.html
           img-dir=image-dir
           img-file='target24tpi-comp.png'
...
{% include figure.html
           img-dir=image-dir
           img-file='a.targetCarrier-comp.png'
...
{% include figure.html
           img-dir=image-dir
           img-file='a.calib_8.4-comp.png'
           alt='Drawing of calib_8.4 fixture'
           caption='Calib_8.4 fixture'
%}


<br>
### Calib_8.4 fixture without overlay plate
...
{% include figure.html
           img-dir=image-dir
           img-file='a.see.calib_8.4-comp.png'
           alt='Drawing of calib_8.4 fixture without overlay plate'
           caption='Calib_8.4 fixture without overlay plate'
%}
