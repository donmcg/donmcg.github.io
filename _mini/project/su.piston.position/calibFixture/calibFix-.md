...
{% endcapture %}
{% capture link-dir %}
  {{site.url}}/mini/project/su.piston.position/calibFixture/
{% endcapture %}


# SU Piston Position Calibration Fixtures 
...
{% assign image-dir = site.url | append: "/assets/mini/project/su.piston.position/calibFixture/series-8/" %}
{% endcomment %}

{% include img_cap_link.html
           img-dir=image-dir
           img-file='series-7/assy.calib.7.2.png'
           alt='drawing of calib_7.2 fixture as link to series 7 blog'
           link-dir=link-dir
           link-file='series-7-calibfix-blog.html'
           caption='<h2> Series 7 Calibration Fixture </h2>'
%}

{% include img_cap_link.html
           img-dir=image-dir
           img-file='series-8/a.calib_8.4-comp.png'
           alt='drawing of calib_8.4 fixture as link to series 8 blog'
           link-dir=link-dir
           link-file='series-8-calibfix-blog.html'
           caption='<h2> Series 8 Calibration Fixture </h2>'
%}
...
The initial micrometer fixture for these kind of measurements provides excellent
...
Each 3p_sensor series specific calibration fixture is intended to overcome some of
these limitations.
...
The 3p_sensor devices are produced on a flex pcb and loaded with
...
The mechanical components for calibration fixtures are all produced from common materials
available at local hardware and lumber yards. The electronic components are sourced
from a well known on-line dealer.

Construction of a calibration fixture begins with a 3/4" birch plywood base
plate upon which subsequent components are stacked.  These pieces are
cut on a table saw and machined on a router table and drill press.
They provide mounting support for the remaining components and is static safe.
...
An additional straight-edge to guide the opposing side of the target carrier 
is conveniently provided by a small metal ruler.

---

<br>
A second base plate is fabricated from 3/4" ply and is constructed
so as to capture the calibration and x-y fixtures in alignment.
