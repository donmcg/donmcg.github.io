...
1. Brass Square Bar working end facing left (operator pov)

2. 3/8em: Square off end of bar to depth ~ 200thou

Note: skip fly cut of step 3 and 4.  No real value and forces cantilever
      once part is flipped over.
x3. 3/8em: Fly cut flatten top surface ~0.75" at end of bar. (< 5thou)
...
x4. 3/8em: Rotate bar 90deg. Step 3 surface away from operator
          Fly cut flatten surface ~0.75" at end of bar. (< 5thou)

5. 1/8em: Establish reference point for top side milling
...
6. 1/8em: Cut first side of tongue
          Advance Z to 150mil
          Advance Y to   5mil
					Turn on mill
...
9. 5/16cs: Countersink screw hole
...
9. 1/8em: Gross cut second side of tongue
          Raise Z and change to 1/8em end mill tool
...
10. Caliper: Verify tongue is 160mil wide (gross).
          Expected thickness is 160mil, desired is 150mil
					Compute delT, the measured - 150mil goal.

11. 1/8em: Finish cut second side of tongue
...
12. 1/8em: Top side dado for cut off.
...
x13. Finalize tongue length, this step allows for subsequent trimming?
...
14. Top surface is done.

15. Dismount bar, rotate 180deg, remount facing left.

16. 3/8em: Rabbet part end to expose tongue tip
...
17. 3/8em: Fly cut to reduce part to 150mil thickness.
...
18. 1/8em: Dado between anchor and tongue
...
19. 1/8cs: chamfer Dado at tongue edge
