...
layout: default
title: Guide Key
tip: guide keys for su position sensors
...
binder:
  ...
  themes: [ guideKey ] # applies to chapter level
---
...
<ol>
<li>
site [Series 7 Guide Key Machining]({{ site.url | append: "/mini/project/su.piston.position/guideKey.7/newKey.machining-blog.html" }})
</li>

<li>
site [Series 8 Guide Key Machining]({{ site.url | append: "/mini/project/su.piston.position/guideKey/series-8-guidekey-blog.html" }})
</li>
</ol>
{% endcomment %}

## Log: [Series 7 Guide Key Machining]({{ site.url | append: "/mini/project/su.piston.position/guideKey/series-7-guidekey-blog.html" }})
## Log: [Series 8 Guide Key Machining]({{ site.url | append: "/mini/project/su.piston.position/guideKey/series-8-guidekey-blog.html" }})
